...
public class FavWidgetProvider extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.marfin.moviecatalogueuiux.TOAST_ACTION";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        Intent toastIntent = new Intent(context, FavWidgetProvider.class);
        toastIntent.setAction(FavWidgetProvider.TOAST_ACTION);
    ...
    public static void updateWidget(Context context) {
        ...
        int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, FavWidgetProvider.class));
